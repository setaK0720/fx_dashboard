                ...
                <Table.Root variant="line" size="sm">
                    <Table.Header>
                        <Table.Row>
                            ...
                            <Table.ColumnHeader color="white" fontSize="xs" bg="gray.800">Elapsed</Table.ColumnHeader>
                            ...
                            <Table.ColumnHeader color="white" fontSize="xs" textAlign="right" bg="gray.800">Lot</Table.ColumnHeader>
                            ...
                            <Table.ColumnHeader color="white" fontSize="xs" textAlign="center" bg="gray.800">Action</Table.ColumnHeader>
                        </Table.Row>
                    </Table.Header>
                    <Table.Body>
                        {positions.map((pos) => (
